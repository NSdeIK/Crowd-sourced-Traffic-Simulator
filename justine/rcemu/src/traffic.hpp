...
public:
  ...
  virtual void init ( void )
  {
    ...
    std::map<int, std::vector<osmium::unsigned_object_id_type> > realtraffic =
    {
      {
        {
          559, {  //Rua de Antero de Quental
            128560448,4573825411,349907807,4573825412,4573825413,4573825414,128560449,5329555464//,122452427,5865201859,5865201862,5865201863,5865201860,4685392624,137993249,1216789894,1216789883,473879871,3897692212,4749945342,128560274
          }
        }
      ,
      
        {
          789, {  //Rua da Constituicao
            122452414,4708552369,6249234559,122452417,5291597578,126634476,4573825436,4573825435,4573825437,1837918503
          }
        }
      ,
        ...
        {
          317, {  //Rua da Boavista
            1788787039,4685392611,1788787081,3148938210,353286182,2397188711,1788787223,2250873416,129953505//,5902247589,5902247588,129953504
          }
        }
      }
    };
