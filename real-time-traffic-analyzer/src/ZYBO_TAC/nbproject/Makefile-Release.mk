...
${OBJECTDIR}/TrafficAnalytics.pb.o: TrafficAnalytics.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TrafficAnalytics.pb.o TrafficAnalytics.pb.cc
...
${OBJECTDIR}/mqttcomm.o: mqttcomm.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mqttcomm.o mqttcomm.c

${OBJECTDIR}/video_processing.o: video_processing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/video_processing.o video_processing.cpp
