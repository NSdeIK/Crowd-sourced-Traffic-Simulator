...
The **Real-Time Traffic Analyzer** project attemps to give a solution for a part of the Robocar World Championship, namely the Automated Sensor Annotations (ASA for short).
